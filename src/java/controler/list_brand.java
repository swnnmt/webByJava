 ...
 * @author mactu
 */
public class list_brand extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet list_brand</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet list_brand at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
         ...
         if(account.getRole()!=1){
          request.getRequestDispatcher("login/login.jsp").forward(request, response);
           ...
           cartegoryDAO c =new  cartegoryDAO();
            List <Brand> list= c.getAll_Brand();
