 ...
 * @author mactu
 */
public class delivery_front extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet delivery_front</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet delivery_front at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
